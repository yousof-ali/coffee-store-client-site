    ...
    <div>
      ...
      <div className="py-8">
        <div className="text-center space-y-2">
          ...
          <Link to={'/addcoffe'} ><button className="border-2 my-2 border-black bg-[#E3B577] text-white rounded p-2 hover:bg-base-100  hover:text-black "> <span className="flex items-center">Add coffee + <BsCupHotFill /></span> </button></Link>
        </div>
      </div>
    </div>
  );
